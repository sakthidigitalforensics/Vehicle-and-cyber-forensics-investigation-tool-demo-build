"""
Sakthi's Vehicle & Cyber Forensics Analysis Tool - local-only Streamlit app.
...
st.set_page_config(page_title="Sakthi's Vehicle & Cyber Forensics Analysis Tool", layout="wide", page_icon="🚗")
...
st.warning(
    "🎭 **Public demo build** — preloaded with synthetic sample cases, no password/encryption gate. "
...
st.sidebar.markdown(
    ...
    align-items:center;justify-content:center;font:700 13px 'Fredoka',sans-serif;color:#2a1030">SF</div>
    <div class="sf-heading" style="font-size:16px;font-weight:600;letter-spacing:-.01em">Sakthi's<br>Forensic Lab</div>
    </div>""",
...
if st.session_state.get("nav") == "dashboard":
    st.title("🏠 Dashboard")
    st.caption("Sakthi's Vehicle & Cyber Forensics Analysis Tool — a private, local-only case workspace.")
